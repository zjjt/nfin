...
class AfterComptaTableZoom extends Component{
...
AfterComptaTableZoom=connect(mapDispatchToProps)(AfterComptaTableZoom);


export default AfterComptaTableZoom;
